...
use App\Filament\Resources\LiPolResource\Pages;
use App\Filament\Resources\LiPolResource\RelationManagers;
...
class LiPolResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListLiPols::route('/'),
            'create' => Pages\CreateLiPol::route('/create'),
            'view' => Pages\ViewLiPol::route('/{record}'),
            'edit' => Pages\EditLiPol::route('/{record}/edit'),
        ];
    }
}
